...
namespace ResearchesMVC.Controllers
{
    ...
    public class CitiesController : Controller
    {
        ...
        public CitiesController(ApplictionDbContext context)
        {
            _context = context;
        }
        ...
        {
            var applictionDbContext = _context.Cities.Include(c => c.State);
        ...
        public async Task<IActionResult> Create([Bind("CityId,Name,StateId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CityId,Name,StateId")] City city)
        {
            if (id != city.CityId)
            {
                return NotFound();
